...
const Term = () => (
  <Main meta={<Meta title="Lorem ipsum" description="Lorem ipsum" />}>
    <p>
      ...
      before using InsomniaSpace.com website (the “service”).
    </p>
    ...
    <p>
      ...
      policy
      <Link href="/privacy"> link</Link> regarding our user data collection. It
    ...
    <p>
      ...
      of website owner, with copyright authorship for this compilation by
      website owner.
    </p>
    ...
    <p>
      ...
      service, or any dispute of any sort that might come between webiste owner
    ...
    <p>
      ...
      court in United States and you consent to exclusive jurisdiction and venue
      of such courts.
    </p>
    ...
    <p>
      ...
      content. When you post your content, you grant website owner
